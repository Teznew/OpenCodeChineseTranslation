...
var MainMenuItems = []MenuItem{
	...
	{Key: "[#]", Name: "编译构建", Value: "build", Desc: "使用 Bun 编译生成 OpenCode 可执行文件。支持 Windows x64、Linux x64 和 macOS。"},
	{Key: "[^]", Name: "部署命令", Value: "deploy", Desc: "将 opencode-cli 和 opencode (如果已编译) 部署到系统 PATH。"},
	{Key: "[=]", Name: "打包三端", Value: "package-all", Desc: "为 Windows x64、Linux x64 以及 macOS (Intel/Apple Silicon) 打包发布版 ZIP 文件，生成 Release Notes。"},
...
var Tutorials = []Tutorial{
	...
	},
	{
		...
		Content: []string{
			...
			"项目地址: github.com/Teznew/OpenCodeChineseTranslation",
		},
	},
}
