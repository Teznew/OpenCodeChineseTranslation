...
|------|------|
| **项目名称** | OpenCode 中文汉化版 |
| **原项目** | https://gh-proxy.com/https://github.com/opencode-ai/opencode |
| **汉化仓库** | https://gh-proxy.com/https://github.com/Teznew/OpenCodeChineseTranslation |
...
```json
{
  ...
  "maintainer": {
    "name": "CodeCreator",
    "github": "https://gh-proxy.com/https://github.com/Teznew/OpenCodeChineseTranslation"
  },
  "modules": {
...
| 链接 | 说明 |
|------|------|
| [OpenCode 官方](https://gh-proxy.com/https://github.com/opencode-ai/opencode) | 原项目仓库 |
| [汉化项目 GitHub](https://gh-proxy.com/https://github.com/Teznew/OpenCodeChineseTranslation) | 本项目 |
...
| [问题反馈](https://gh-proxy.com/https://github.com/Teznew/OpenCodeChineseTranslation/issues) | 提交 Issue |
